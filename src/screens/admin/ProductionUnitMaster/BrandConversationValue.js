        ...
        <View style={styles.popupContainer}>
          <View style={styles.popupContent}>
            ...
            <Title
              ...
              {selectedUser.item.service_name}
            </Title>
            ...
            <View style={styles.row}>
              ...
              <Text
                ...
                selectable={true}>
                {selectedUser.item.category_name}
              </Text>
            </View>
            <View style={styles.row}>
              <Text
            ...
            <View style={styles.row}>
              ...
              <Text
                ...
                selectable={true}>
                {selectedUser.item.conversion_value}
              </Text>
            </View>
            ...
            <View style={styles.row}>
              ...
              <Text
                ...
                selectable={true}>
                {selectedUser.item.view_status === '1' ? 'Yes' : 'No'}
              </Text>
            </View>
          </View>
        </View>
...
export default ABrandConversationValue;
