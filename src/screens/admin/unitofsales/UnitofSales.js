...
function UnitofSales({route, navigation}) {
 ...
 useEffect(() => {
  ...
  const AddCallback = () => {
    navigation.navigate('AddUnitofSales', {
      type: 'add',
      fetchData: FetchData,
    });
  };
    ...
    return (
      <Pressable
        ...
        <View
          ...
          <Image
            source={require('../../../../assets/unitofsales.png')}
  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: '#fff'}}>
     <Header title='Unit of Sales' navigation={navigation} />
     {isLoading ? (
        <View
          style={[
            Styles.flex1,
