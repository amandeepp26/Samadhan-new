...
const QuotationApprovePendingList = ({
  ...
  const update = async () => {
    ...
    try {
      ...
      const resp = await axios.post(
        `${BASE_URL_Contractor}/${
          text == 'Reject'
            ? 'contractor_quotation_reject'
            : 'contractor_quotation_selfapprove'
        }/`,
        datas,
        {
  ...
  const FetchData = () => {
    ...
    Provider.createDFContractor(
      Provider.API_URLS.contractor_quotation_approved_pendng_list,
      params,
    )
      .then(response => {
      ...
      <RBSheet
        ...
        <View>
          ...
          <ScrollView style={{marginBottom: 64}}>
            ...
            <List.Item
              title="Client Status"
              description={current.client_approve_status_name}
            />
            <List.Item
            ...
            {current?.action_button?.includes('Preview Quotation') && (
            ...
            {current?.action_button?.includes('Self & Final Approve') && (
              <View style={{alignItems: 'center'}}>
                <Button
                  mode="outlined"
                  style={{
                  ...
                  <Text style={{color: 'green'}}>Self & Final Approve</Text>
                </Button>
              </View>
            )}
