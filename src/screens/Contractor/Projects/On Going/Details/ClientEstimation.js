      ...
      {type === "3" && (
        <>
          ...
          <LabelInput
            ...
            value={`${data?.customerdata?.["Client Name"] || "NONE"} - ${
              data?.customerdata?.["Client Mobile No"] || "NONE"
            }`}
          />
          <HDivider />
          <LabelInput
            ...
            value={
              <View>
                {data?.supervisordata?.map((obj, index) => {
                  return (
                    <Text>
                      {index + 1}. {obj}
                    </Text>
      ...
      {type === "4" && (
        <>
          ...
          <LabelInput
            ...
            value={`${data?.architectdata?.["Architect Name"] || "NONE"} - ${
              data?.architectdata?.["Architect Mobile No"] || "NONE"
            }`}
          />
          <HDivider />
          <LabelInput
  ...
  return (
    ...
    <View style={{ padding: 16 }}>
      {data.project_type === "2" || data.project_type === "1" ? (
          ...
          <CreateSCCards
            ...
            title={
              <LabelInput
                white
                label="Client Details"
                value={` ${state?.customerdata?.["Client Name"] || "NONE"} - ${
                  state?.customerdata?.["Client Mobile No"] || "NONE"
                }`}
              />
            }
          />
        ...
        <Card data={{ ...state, ...data }} type={data.project_type} />
      )}
    </View>
    </SafeAreaView>
  );
