...
import SendBOQ from '../../../Architect/Budget & BOQs/components/SendBOQ';
...
const BOQ = ({ route, navigation }) => {
  ...
  const accept_and_send = async boqsend_refno => {
    const params = {
      data: {
        Sess_UserRefno,
        budget_refno: route.params.data.budget_refno,
    ...
    <>
      {data.boq_details && (
        <SendBOQ
          ...
          boq_no={data?.boq_details[0]?.boq_no}
          service_refno={data?.boq_details?.[0].service_refno}
                  ...
                  <Table
                    ...
                    <Row
                      data={[
                        ...
                        'Contractor Approve Status',
                        'Architect Approve Status',
                        'Your Approve Status',
                        'Action',
                      ]}
                      widthArr={[200, 200, 250, 250, 300, 250, 250]}
                      style={styles.header}
                      textStyle={styles.headertext}
                    />
                  </Table>
                            ...
                            return (
                              <Row
                                ...
                                data={[
                                  ...
                                  obj?.architect_accept_status,
                                  obj?.client_approve_status,
                                  obj?.client_grid_action_button[0] ===
                                  'View & Confirm Work Order' && (
                                    <Button
                                      style={{
                                        width: '80%',
                                        alignSelf: 'center',
                                      ...
                                      onPress={() =>
                                        navigation.navigate(
                                          'ViewConfirmBudget',
                                          {
                                            ...
                                            boqsend_refno: obj?.boqsend_refno,
                                          },
                                        )
                                      }>
