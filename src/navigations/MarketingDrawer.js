...
import GeneralUserHomeScreen from '../screens/Home';
import MarketingHomeScreen from '../screens/Marketing/HomeScreen';
...
export default function MarketingDrawer({loginUser}) {
  ...
  return (
    <Drawer.Navigator
      ...
      <Drawer.Screen
        name="Home"
        component={props => (
          <MarketingHomeScreen {...props} loginUser={loginUser} />
        )}
