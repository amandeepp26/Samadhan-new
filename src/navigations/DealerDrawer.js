...
import DealerHomeScreen from '../screens/DealerHomeScreen';
...
function CustomDrawerContent({
  ...
  console.warn("imageeeeeeee",profileIcon)
  return (
...
export default function DealerDrawer({loginUser}) {
  ...
  const getMenuList = async () => {
    ...
    console.warn('params menu--->', params);
  ...
  return (
    <Drawer.Navigator
      ...
      <Drawer.Screen
        name="Home"
        component={props => (
          <DealerHomeScreen {...props} loginUser={loginUser} />
        )}
